...
#include "base/view.h"
#include "base/input/gui_input_adapter.h"
#include "base/gui/widget.h"
#include "base/utility/make_unique.h"
#include "base/graphics/gui_renderer.h"
...
public:
    ...
    inline auto get_children(const widget& parent) -> decltype(make_range(parent_widget_map.equal_range(&parent))) {
        return make_range(parent_widget_map.equal_range(&parent));
    }

    inline auto get_children(const widget& parent) const -> decltype(make_range(parent_widget_map.equal_range(&parent))) {
        return make_range(parent_widget_map.equal_range(&parent));
    }
