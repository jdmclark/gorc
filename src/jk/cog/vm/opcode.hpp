...
namespace gorc {
    namespace cog {
        ...
        enum class opcode : uint8_t {
            ...
            loadg, // LOADG [address] : loads from global heap
            loadgi, // LOADGI [address] : load indexed from global heap
            stor, // STOR [address] : stores to heap
            stori, // STORI [address] : store indexed
            storg, // STORG [address] : stores to global heap
            storgi, // STORGI [address] : store indexed to global heap
