...
gorc::raw_material_texture_record::raw_material_texture_record(deserialization_constructor_tag,
                                                               binary_input_stream &bis)
{
    width = binary_deserialize<uint32_t>(bis);
    height = binary_deserialize<uint32_t>(bis);
    uses_transparency = binary_deserialize<uint32_t>(bis);
...
gorc::raw_material::raw_material(deserialization_constructor_tag, binary_input_stream &bis)
{
