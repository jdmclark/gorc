...
Gorc::Game::Components::Components(Diagnostics::Report& Report, Event::EventBus& EventBus, sf::Window& Window, const sf::Input& Input,
	...
	: Report(Report), EventBus(EventBus), Window(Window), Input(Input), FileSystem(FileSystem),
