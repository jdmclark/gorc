...
Gorc::Game::Components::Components(Diagnostics::Report& Report, Event::EventBus& EventBus, sf::Window& Window,
	...
	: Report(Report), EventBus(EventBus), Window(Window), FileSystem(FileSystem),
