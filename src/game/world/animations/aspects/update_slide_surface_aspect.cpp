#include "update_slide_surface_aspect.h"
...
void gorc::game::world::animations::aspects::update_slide_surface_aspect::update(time t, entity_id, components::slide_surface& anim) {
