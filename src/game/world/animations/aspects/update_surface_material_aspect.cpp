#include "update_surface_material_aspect.h"
...
void gorc::game::world::animations::aspects::update_surface_material_aspect::update(time t, entity_id, components::surface_material& anim) {
