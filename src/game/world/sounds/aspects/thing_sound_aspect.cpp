...
gorc::game::world::sounds::aspects::thing_sound_aspect::thing_sound_aspect(entity_component_system<thing_id> &cs)
...
void gorc::game::world::sounds::aspects::thing_sound_aspect::update(time_delta,
    ...
    for(auto &sound : ecs.find_component<components::sound>(ts.sound)) {
