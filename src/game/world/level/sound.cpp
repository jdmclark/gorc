...
void Gorc::Game::World::Level::Sound::PlayAmbient(const Content::Assets::Sound& buffer, float volume, float panning, FlagSet<Content::Assets::SoundFlag> flags) {
	expired = false;
...
void Gorc::Game::World::Level::Sound::PlayVoice(const Content::Assets::Sound& buffer, float volume, FlagSet<Content::Assets::SoundFlag> flags) {
	expired = false;
	update_position = false;
...
void Gorc::Game::World::Level::Sound::PlayPositional(const Content::Assets::Sound& buffer, const Math::Vector<3>& position,
		float volume, float minrad, float maxrad, FlagSet<Content::Assets::SoundFlag> flags) {
	expired = false;
...
void Gorc::Game::World::Level::Sound::PlaySoundLocal(const Content::Assets::Sound& sound, float volume, float panning,
	...
	if(flags & Content::Assets::SoundFlag::Voice) {
...
void Gorc::Game::World::Level::Sound::PlaySoundThing(const LevelModel& model, const Content::Assets::Sound& sound, unsigned int thing, float volume,
		float minrad, float maxrad, FlagSet<Content::Assets::SoundFlag> flags) {
	this->thing = thing;
	update_position = (flags & Content::Assets::SoundFlag::ThingOriginMovesWithThing);
