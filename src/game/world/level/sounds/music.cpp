...
void gorc::game::world::level::sounds::music::internal_play_song(int song) {
...
void gorc::game::world::level::sounds::music::play_song(int start, int end, int loopto) {
...
void gorc::game::world::level::sounds::music::set_volume(float volume) {
