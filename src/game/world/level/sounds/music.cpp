...
void Gorc::Game::World::Level::Music::InternalPlaySong(int song) {
...
void Gorc::Game::World::Level::Music::PlaySong(int start, int end, int loopto) {
...
void Gorc::Game::World::Level::Music::SetVolume(float volume) {
	music.SetVolume(100.0f * volume);
}

void Gorc::Game::World::Level::Music::Update(double dt) {
