...
gorc::game::world::level::animations::surface_light_animation::surface_light_animation(level_model& model, unsigned int surface, float start_light,
...
void gorc::game::world::level::animations::surface_light_animation::update(double dt) {
