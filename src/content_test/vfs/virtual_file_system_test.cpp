...
public:
    int GetIntFromFile(gorc::content::vfs::virtual_file_system& vfs, const boost::filesystem::path& filename) {
        std::unique_ptr<gorc::io::read_only_file> file = vfs.open(filename);
        gorc::diagnostics::stored_report report;
        gorc::text::source src(filename, *file);
...
test_case(Basic) {
    gorc::content::vfs::virtual_file_system vfs("src/content_test/vfs/test_vfs/restricted", "src/content_test/vfs/test_vfs/resource", "src/content_test/vfs/test_vfs/episode", report);
...
test_case(Mod1) {
    gorc::content::vfs::virtual_file_system vfs("src/content_test/vfs/test_vfs/restricted", "src/content_test/vfs/test_vfs/resource", "src/content_test/vfs/test_vfs/episode",
