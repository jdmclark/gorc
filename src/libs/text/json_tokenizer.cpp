...
tok_result gorc::json_tokenizer_state_machine::handle_initial_state(char current_char)
{
    if(current_char == '\0') {
...
tok_result gorc::json_tokenizer_state_machine::handle_skip_line_comment_state(char ch)
{
    if(ch == '\0' || ch == '\n') {
        return discard_directive(tokenizer_state::initial);
    }
...
tok_result gorc::json_tokenizer_state_machine::handle_identifier_state(char ch)
{
...
tok_result gorc::json_tokenizer_state_machine::handle_string_state(char current_char)
{
    if(current_char == '\\') {
...
tok_result gorc::json_tokenizer_state_machine::handle_escape_sequence_state(char ch)
{
...
tok_result gorc::json_tokenizer_state_machine::handle_hex_octal_prefix_state(char current_char)
{
...
tok_result gorc::json_tokenizer_state_machine::handle_hex_required_digit_state(char ch)
{
    if(std::isxdigit(ch)) {
...
tok_result gorc::json_tokenizer_state_machine::handle_hex_digit_sequence_state(char ch)
{
    if(std::isxdigit(ch)) {
        return append_directive(tokenizer_state::hex_digit_sequence, ch);
    }
...
tok_result gorc::json_tokenizer_state_machine::handle_oct_digit_sequence_state(char ch)
{
    if(ch >= '0' && ch <= '7') {
...
tok_result gorc::json_tokenizer_state_machine::handle_digit_sequence_state(char current_char)
{
...
tok_result gorc::json_tokenizer_state_machine::handle_decimal_required_digit_state(char ch)
{
    if(std::isdigit(ch)) {
...
tok_result gorc::json_tokenizer_state_machine::handle_decimal_digit_sequence_state(char ch)
{
    if(std::isdigit(ch)) {
        return append_directive(tokenizer_state::decimal_digit_sequence, ch);
    }
...
tok_result gorc::json_tokenizer_state_machine::handle_decimal_exponent_sign_state(char ch)
{
    if(ch == '+' || ch == '-') {
...
tok_result gorc::json_tokenizer_state_machine::handle_decimal_exponent_required_digit_state(char ch)
{
    if(std::isdigit(ch)) {
...
tok_result gorc::json_tokenizer_state_machine::handle_decimal_exponent_sequence_state(char ch)
{
    if(std::isdigit(ch)) {
        return append_directive(tokenizer_state::decimal_exponent_sequence, ch);
    }
...
tok_result gorc::json_tokenizer_state_machine::handle(char ch)
{
...
gorc::token_type gorc::json_tokenizer_state_machine::get_type() const
{
    return current_type;
}

std::string const & gorc::json_tokenizer_state_machine::get_reason() const
{
    return reason;
}
