...
template <typename T> auto dispatch_set_mouse_cursor_position(T& view, const gorc::time& time, const vector<2, int>& cursor_pos)
...
template <typename T> auto dispatch_handle_mouse_input(T& view, const gorc::time& time) -> decltype(view.handle_mouse_input(time)) {
...
template <typename T> auto dispatch_handle_keyboard_input(T& view, const gorc::time& time) -> decltype(view.handle_keyboard_input(time)) {
...
template <typename T> auto dispatch_handle_text_input(T& view, const gorc::time& time, char ch) -> decltype(view.handle_text_input(time, ch)) {
...
public:
    ...
    virtual void set_mouse_cursor_position(const gorc::time& time, const vector<2, int>& cursor_pos) override {
    ...
    virtual void handle_mouse_input(const gorc::time& time) override {
        dispatch_handle_mouse_input(view, time);
    }

    virtual void handle_keyboard_input(const gorc::time& time) override {
        dispatch_handle_keyboard_input(view, time);
    }

    virtual void handle_text_input(const gorc::time& time, char ch) override {
