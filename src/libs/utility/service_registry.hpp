    ...
    public:
        ...
        void add(ServiceT &svc)
        {
            ...
            if(!rv) {
                throw std::runtime_error(strcat(
                    "service_registry::add service ", typeid(ServiceT).name(), " multiple times"));
            }
        }
        ...
        ServiceT &get() const
        {
            ...
            if(it != services.end()) {
                ...
                throw std::runtime_error(strcat(
                    "service_registry::get service ", typeid(ServiceT).name(), " not registered"));
            }
        }
        ...
        bool has() const
        {
            ...
            if(it != services.end()) {
                ...
                return parent.get_value()->has<ServiceT>();
            }
            else {
                return false;
            }
